SRCS =	ft_strlen.c ft_strrchr.c ft_atoi.c ft_isalnum.c ft_isdigit.c \
	   ...
	   ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_isascii.c ft_memmove.c ft_memchr.c ft_calloc.c ft_strdup.c
